                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                ...
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control form-control-user" minlength="6" maxlength="50" value="<?php echo $email; ?>" placeholder="Email" required>
                                ...
                                <div class="form-group">
                                    <input type="password" name="c-pwd" class="form-control form-control-user" minlength="8" maxlength="30" placeholder="Confirm Password" required>
